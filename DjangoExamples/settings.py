"""
Django settings for DjangoExamples project.
...
SECRET_KEY = '(&gzw0$%m402@z71&z6w%sh7&$e#+5&#6iw)w$s&g&z9=vh+ac'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates'),
				 os.path.join(BASE_DIR, "multidbexample/templates/multidbexample"),]
        ,
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
